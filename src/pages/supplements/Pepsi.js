...
const Pepsi = (props) => {
    ...
    return (
        <Form>
            ...
            <Input type="number" id="numberPepsi" onChange={event => 
                {
                    event.persist(); 
            ...
            <Input type="number" id="numberDietPepsi" onChange={event => 
                {
                    event.persist(); 
            ...
            <Input type="number" id="numberMountainDew" onChange={event => 
                {
                    event.persist(); 
            ...
            <ButtonGroup> 
                ...
                <Button color="primary" onClick={() => {props.addSupplement("PEPSI", pepsiSupplement); props.changeSelected("None"); }} 
                disabled={!(pepsiSupplement.numberPepsi || pepsiSupplement.numberDietPepsi || pepsiSupplement.numberMountainDew)}>
                    Add</Button>
            </ButtonGroup>
        </Form>
