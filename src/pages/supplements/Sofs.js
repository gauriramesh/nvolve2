...
const Sofs = props => {
  const [sofsSupplement, setSofsSupplement] = useState({
  ...
  return (
    <Form>
      ...
      <Input
        ...
        onChange={event => {
          event.persist();
          setSofsSupplement(prev => ({
            ...prev,
            budgetDescription: event.target.value
          }));
        }}
      />
      ...
      <ButtonGroup>
        ...
        <Button
          ...
          disabled={
            !(sofsSupplement.budgetDescription && sofsSupplement.budgetFile)
          }
        >
          Add
        </Button>
